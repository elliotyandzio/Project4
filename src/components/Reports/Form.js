...
const TeamsForm = ({ handleChange, handleSubmit, report, handlePositionSelect, handleStartLocationChange, handleEndLocationChange }) => {
  ...
  const technicalOverall = () => {
    ...
    } if (report.position === 'Centre Midfield') {
        if(typeof report.rangeOfPassing !== 'undefined' && typeof report.receivingTechniques !== 'undefined' && typeof report.tackling !== 'undefined' && typeof report.longShots !== 'undefined' && typeof report.finishing !== 'undefined') {
          const values = (parseInt(report.rangeOfPassing) + parseInt(report.receivingTechniques) + parseInt(report.tackling) + parseInt(report.longShots) + parseInt(report.finishing));
          const overall = Math.round(values/5);
          return overall;
      }
  ...
  const tacticalOverall = () => {
    if(report.position === 'Goalkeeper') {
      ...
      if(typeof report.tracking !== 'undefined' && typeof report.positioning !== 'undefined' && typeof report.recovery !== 'undefined' && typeof report.decisionMaking !== 'undefined' && typeof report.readingOfGame) {
        const values = (parseInt(report.tracking) + parseInt(report.positioning) + parseInt(report.recovery) + parseInt(report.decisionMaking) + parseInt(report.readingOfGame));
        const overall = Math.round(values/5);
        return overall;
      }
    } if (report.position === 'Attacking Midfield') {
      if(typeof report.linkPlay !== 'undefined' && typeof report.penetration !== 'undefined' && typeof report.movement !== 'undefined' && typeof report.tracking !== 'undefined' && typeof report.playingBetweenLines) {
  ...
  const mentalOverall = () => {
    if(report.position === 'Goalkeeper') {
      ...
      if(typeof report.determination !== 'undefined' && typeof report.errorReaction !== 'undefined' && typeof report.takeInfo !== 'undefined' && typeof report.tenacity !== 'undefined' && typeof report.bravery) {
        const values = (parseInt(report.determination) + parseInt(report.errorReaction) + parseInt(report.takeInfo) + parseInt(report.tenacity) + parseInt(report.bravery));
        const overall = Math.round(values/5);
        return overall;
      }
    } if (report.position === 'Attacking Midfield') {
  ...
  const physicalOverall = () => {
    if(report.position === 'Goalkeeper') {
      ...
      if(typeof report.endurance !== 'undefined' && typeof report.boxTobox !== 'undefined' && typeof report.strength !== 'undefined' && typeof report.first5 !== 'undefined' && typeof report.pace !== 'undefined') {
        const values = (parseInt(report.endurance) + parseInt(report.boxTobox) + parseInt(report.strength) + parseInt(report.first5) + parseInt(report.pace));
        const overall = Math.round(values/5);
        return overall;
      }
    } if (report.position === 'Attacking Midfield') {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <div className="columns">
            ...
            <div className="column is-3">
              <input type="range" min="1" max="5" className="slider" name="positioning" onChange={handleChange} value={parseInt(report.positioning) || ''}/>
            </div>
            <div className="column is-1">
              {report.positioning}
            </div>
          ...
          <div className="columns">
            <div className="column is-2">
              <label htmlFor="readingOfGame">Reading of the Game</label>
            </div>
            <div className="column is-3">
              <input type="range" min="1" max="5" className="slider" name="readingOfGame" onChange={handleChange} value={parseInt(report.readingOfGame) || ''}/>
            </div>
            <div className="column is-1">
              {report.readingOfGame}
            </div>
          </div>
          ...
          <div className="columns">
            ...
            <div className="column is-2">
              <label htmlFor="first5">First 5</label>
            </div>
            <div className="column is-3">
              <input type="range" min="1" max="5" className="slider" name="first5" onChange={handleChange} value={parseInt(report.first5) || ''}/>
            </div>
        ...
        <div>
          ...
          <div className="columns">
            <div className="column is-2">
              <label htmlFor="playInTightAreas">Playing in Tight Areas</label>
            </div>
            <div className="column is-3">
          ...
          <div className="columns">
            ...
            <div className="column is-2">
              <label htmlFor="changeOfDirection">Change of Directrion</label>
            </div>
            <div className="column is-3">
