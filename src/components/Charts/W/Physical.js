...
class WingerPhysicalChart extends React.Component {
  ...
  componentDidUpdate = () => {
    ...
    const ctx = document.getElementById('wingerPhysical');
  ...
  render() {
    return(
      <div>
        <canvas id="wingerPhysical"></canvas>
      </div>
    );
  }
}

export default WingerPhysicalChart;
