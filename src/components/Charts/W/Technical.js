...
class WingerTechnicalChart extends React.Component {
  ...
  componentDidUpdate = () => {
    ...
    const ctx = document.getElementById('wingerMidTechnical');
  ...
  render() {
    return(
      <div>
        <canvas id="wingerMidTechnical"></canvas>
      </div>
    );
  }
}

export default WingerTechnicalChart;
