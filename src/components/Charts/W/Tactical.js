...
class WingerTacticalChart extends React.Component {
  ...
  componentDidUpdate = () => {
    ...
    const ctx = document.getElementById('wingerTactical');
  ...
  render() {
    return(
      <div>
        <canvas id="wingerTactical"></canvas>
      </div>
    );
  }
}

export default WingerTacticalChart;
