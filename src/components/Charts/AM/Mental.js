...
class AttackingMidMentalChart extends React.Component {
  ...
  componentDidUpdate = () => {
    ...
    const ctx = document.getElementById('attackingMidMental');
  ...
  render() {
    return(
      <div>
        <canvas id="attackingMidMental"></canvas>
      </div>
    );
  }
}

export default AttackingMidMentalChart;
